...
lyr_AlternativeFoundationGrantees_0.set('fieldLabels', {'fid': 'hidden field', 'ZIP Code': 'inline label - always visible', 'Bailey Park NDC': 'no label', 'College Career & Beyond': 'no label', 'Detroit Food Academy': 'no label', 'Developing KIDS': 'no label', 'NW Goldberg Cares': 'no label', 'Number of Grantees Serving This ZIP': 'inline label - always visible', });
